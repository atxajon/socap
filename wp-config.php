<?php
define( 'WPCACHEHOME', '/Applications/MAMP/htdocs/socap/wp-content/plugins/wp-super-cache/' );
define( 'WP_CACHE', true );
if ( $_SERVER["HTTP_HOST"] ==  "detenaes-cp511.wordpresstemporal.com"  && preg_match("/socap.es/",$_SERVER["REQUEST_URI"])){
 define( 'WP_HOME', 'http://socap.local' );
 define( 'WP_SITEURL', 'http://socap.local' );
